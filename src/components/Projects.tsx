    ...
    <div className="section-container">
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-12 max-w-6xl mx-auto">
        {projects.map((p) => (
          <div
            key={p.title}
            className="bg-card border border-border rounded-xl p-8 pt-10 flex flex-col card-hover relative"
          >
            {/* Timeline */}
            <div className="absolute top-4 right-5 text-xs text-muted-foreground font-medium">
              {p.timeline}
            </div>
